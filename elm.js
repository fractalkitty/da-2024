...
var $author$project$Main$NewStar = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$Star = F5(
	function (x, y, vx, vy, lifetime) {
		return {A: lifetime, am: vx, an: vy, H: x, I: y};
	});
...
var $author$project$Main$starGenerator = A6(
	$elm$random$Random$map5,
	$author$project$Main$Star,
	A2($elm$random$Random$float, -4, 4),
	A2($elm$random$Random$float, -4, 4),
	A2($elm$random$Random$float, -0.05, 0.05),
	A2($elm$random$Random$float, -0.05, 0.05),
	A2($elm$random$Random$float, 50, 300));
var $author$project$Main$generateStar = A2($elm$random$Random$generate, $author$project$Main$NewStar, $author$project$Main$starGenerator);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{u: _List_Nil, G: 0},
		$author$project$Main$generateStar);
};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {K: oldTime, ah: request, aj: subs};
	});
...
var $author$project$Main$updateStar = function (star) {
	return _Utils_update(
		star,
		{A: star.A - 5, H: star.H + star.am, I: star.I + star.an});
};
var $author$project$Main$updateStars = function (stars) {
	return A2(
		$elm$core$List$map,
		$author$project$Main$updateStar,
		A2(
		...
		if (!msg.$) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						u: $author$project$Main$updateStars(model.u),
						G: model.G + delta
					}),
				$author$project$Main$generateStar);
		} else {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						u: A2($elm$core$List$cons, star, model.u)
					}),
...
var $author$project$Main$viewStar = function (star) {
	return A2(
		$elm$svg$Svg$circle,
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$cx(
				$elm$core$String$fromFloat(star.H)),
				$elm$svg$Svg$Attributes$cy(
				$elm$core$String$fromFloat(star.I)),
				$elm$svg$Svg$Attributes$r('0.25'),
				$elm$svg$Svg$Attributes$fill('white'),
				$elm$svg$Svg$Attributes$opacity(
				$elm$core$String$fromFloat(star.A / 100))
			]),
		_List_Nil);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$transform('translate(48, 32)')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$svg$Svg$Attributes$opacity('0.9')
							]),
						_List_Nil),
						A2(
						$elm$svg$Svg$g,
						_List_Nil,
						A2($elm$core$List$map, $author$project$Main$viewStar, model.u))
					]))
			]));
};
